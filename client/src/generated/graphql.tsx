...
export type GetResidencesLimitQuery = {
    __typename?: 'Query';
    getResidencesLimit: {
        __typename?: 'ResidenceResponse';
        errors?: Maybe<
 ...
 * });
 */
export function useGetResidencesLimitQuery(
    baseOptions: Apollo.QueryHookOptions<
        GetResidencesLimitQuery,
        GetResidencesLimitQueryVariables
    >
) {
    const options = { ...defaultOptions, ...baseOptions };
    return Apollo.useQuery<
        GetResidencesLimitQuery,
        GetResidencesLimitQueryVariables
    >(GetResidencesLimitDocument, options);
}
export function useGetResidencesLimitLazyQuery(
...
export type GetResidencesLimitQueryHookResult = ReturnType<
    typeof useGetResidencesLimitQuery
>;
export type GetResidencesLimitLazyQueryHookResult = ReturnType<
    typeof useGetResidencesLimitLazyQuery
>;
export type GetResidencesLimitQueryResult = Apollo.QueryResult<
    GetResidencesLimitQuery,
    GetResidencesLimitQueryVariables
>;
