...
export type RegularLocationFragment = {
    __typename?: 'Location';
    loc_id: number;
    full_address: string;
...
export type RegularLocationResponseFragment = {
    __typename?: 'LocationResponse';
    errors?: Maybe<
...
export type GetLocationsByGeoScopeQuery = {
    __typename?: 'Query';
    getLocationsByGeoScope: {
        __typename?: 'LocationResponse';
        errors?: Maybe<
            Array<{ __typename?: 'FieldError'; field: string; message: string }>
        >;
 ...
 * });
 */
export function useGetLocationsBoundingBoxQuery(
    baseOptions: Apollo.QueryHookOptions<
        GetLocationsBoundingBoxQuery,
        GetLocationsBoundingBoxQueryVariables
    >
) {
    const options = { ...defaultOptions, ...baseOptions };
    return Apollo.useQuery<
        GetLocationsBoundingBoxQuery,
        GetLocationsBoundingBoxQueryVariables
    >(GetLocationsBoundingBoxDocument, options);
}
export function useGetLocationsBoundingBoxLazyQuery(
...
export type GetLocationsBoundingBoxQueryHookResult = ReturnType<
    typeof useGetLocationsBoundingBoxQuery
>;
export type GetLocationsBoundingBoxLazyQueryHookResult = ReturnType<
    typeof useGetLocationsBoundingBoxLazyQuery
>;
export type GetLocationsBoundingBoxQueryResult = Apollo.QueryResult<
    GetLocationsBoundingBoxQuery,
    GetLocationsBoundingBoxQueryVariables
>;
export const GetLocationsByGeoScopeDocument = gql`
    query GetLocationsByGeoScope(
        $options: LocationQueryOptions
        $place_id: String!
    ) {
 ...
 * });
 */
export function useGetLocationsByGeoScopeQuery(
    baseOptions: Apollo.QueryHookOptions<
        GetLocationsByGeoScopeQuery,
        GetLocationsByGeoScopeQueryVariables
    >
) {
    const options = { ...defaultOptions, ...baseOptions };
    return Apollo.useQuery<
        GetLocationsByGeoScopeQuery,
        GetLocationsByGeoScopeQueryVariables
    >(GetLocationsByGeoScopeDocument, options);
}
export function useGetLocationsByGeoScopeLazyQuery(
    baseOptions?: Apollo.LazyQueryHookOptions<
        GetLocationsByGeoScopeQuery,
        GetLocationsByGeoScopeQueryVariables
    >
...
export type GetLocationsByGeoScopeQueryHookResult = ReturnType<
    typeof useGetLocationsByGeoScopeQuery
>;
export type GetLocationsByGeoScopeLazyQueryHookResult = ReturnType<
    typeof useGetLocationsByGeoScopeLazyQuery
>;
export type GetLocationsByGeoScopeQueryResult = Apollo.QueryResult<
    GetLocationsByGeoScopeQuery,
    GetLocationsByGeoScopeQueryVariables
>;
