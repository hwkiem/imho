...
export class Migration20220128202530 extends Migration {
    async up(): Promise<void> {
        ...
        this.addSql(
            'alter table "residence" add constraint "residence_place_id_unit_unique" unique ("place_id", "unit");'
        );
    }
    ...
    async down(): Promise<void> {
        ...
        this.addSql(
            'alter table "residence" drop constraint "residence_place_id_unit_unique";'
        );
    }
}
