...
export class Migration20220117194548 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "review" ("id" uuid not null, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "feedback" varchar(255) not null, "residence_id" uuid null, "flag_string" varchar(255) not null);');
